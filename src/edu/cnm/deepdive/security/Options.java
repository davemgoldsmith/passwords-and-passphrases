...
public class Options {
	...
	private static final String PASSWORD_OPTIONS_CONFLICT_WARNING = "pw.opts.conflict.message";
	private static final String PASSPHRASE_OPTIONS_CONFLICT_WARNING = "pp.opts.conflict.message";
	...
	private static void validateCommandLine(HashMap<String, Object>map, ResourceBundle messageBundle) 
		...
		if (map.containsKey("m")){ //Password mode
